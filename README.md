...
[![Desktop](https://imgur.com/a/LlO8nlG)](https://www.youtube.com/watch?v=QFexSXmQu-A "Desktop")
...
2. In [BackendConstants.cs](https://github.com/andrewchungxam/2019AzureBlobLocalOnly/blob/master/AzureBlobStorageSampleApp.Mobile.Shared/Constants/BackendConstants.cs), change the value of `PostPhotoBlobFunctionKey` to match your Azure Function Key for PostBlob (Also, the URL should be updated to match your too!)
